...
<body>
 ...
 <%
     ...
     try{
         ...
         System.out.println("Update Connection Con OK");
         ...
         while(rs.next()){
       	...
       	// out.print(sid+"   "+nm+" "+gen+" "+sub+" "+m);
       	 %>
       	 <div class="modal-body">
       <form action="nupdt.jsp" method="get">
       
        <div class="mb-3">
  <label for="exampleFormControlInput1" class="form-label">Student Id</label>
  <input type="text" readonly="readonly" class="form-control" value="<%=sid %>" name="sid"  placeholder="Student Id" >
</div>
       <div class="mb-3">
